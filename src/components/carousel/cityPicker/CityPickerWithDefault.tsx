...
interface CityPickerWithDefaultProps {
    choiceReporter: Function;
    defaultCity: string | null;
}

const CityPickerWithDefault: React.FC<CityPickerWithDefaultProps> = ({ choiceReporter, defaultCity }: CityPickerWithDefaultProps) => {
...
export default CityPickerWithDefault;
